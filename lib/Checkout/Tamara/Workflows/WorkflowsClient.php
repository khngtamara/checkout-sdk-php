...
namespace Checkout\Tamara\Workflows;
...
use Checkout\Tamara\Workflows\Reflows\ReflowRequest;
...
class WorkflowsClient extends Client
{
    ...
    /**
     * @param \Checkout\Tamara\Workflows\Reflows\ReflowRequest $reflowRequest
     * @return array
     * @throws \Checkout\Tamara\CheckoutApiException
     */
